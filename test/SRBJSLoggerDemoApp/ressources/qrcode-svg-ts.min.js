...
(QR8bitByte.prototype = {
    ...
    setupPositionAdjustPattern: function () {
      for (var t = QRUtil.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
        for (var r = 0; r < t.length; r++) {
          var o = t[e],
            n = t[r];
          if (null == this.modules[o][n]) for (var i = -2; i <= 2; i++) for (var s = -2; s <= 2; s++) this.modules[o + i][n + s] = -2 == i || 2 == i || -2 == s || 2 == s || (0 == i && 0 == s);
        }
    },
        ...
        for (6 == s && s--; ; ) {
          for (var a = 0; a < 2; a++)
            if (null == this.modules[o][s - a]) {
              var h = !1;
              i < t.length && (h = 1 == ((t[i] >>> n) & 1)), QRUtil.getMask(e, o, s - a) && (h = !h), (this.modules[o][s - a] = h), -1 == --n && (i++, (n = 7));
            }
  ...
  (QRCodeModel.createBytes = function (t, e) {
    for (var r = 0, o = 0, n = 0, i = new Array(e.length), s = new Array(e.length), a = 0; a < e.length; a++) {
      var h = e[a].dataCount,
        l = e[a].totalCount - h;
      (o = Math.max(o, h)), (n = Math.max(n, l)), (i[a] = new Array(h));
      for (var u = 0; u < i[a].length; u++) i[a][u] = 255 & t.buffer[u + r];
      r += h;
      var d = QRUtil.getErrorCorrectPolynomial(l),
        g = new QRPolynomial(i[a], d.getLength() - 1).mod(d);
    ...
    var R = new Array(c),
      m = 0;
    for (u = 0; u < o; u++) for (a = 0; a < e.length; a++) u < i[a].length && (R[m++] = i[a][u]);
        ...
        for (var e = t.getModuleCount(), r = 0, o = 0; o < e; o++)
          for (var n = 0; n < e; n++) {
            for (var i = 0, s = t.isDark(o, n), a = -1; a <= 1; a++)
              if (!(o + a < 0 || e <= o + a)) for (var h = -1; h <= 1; h++) n + h < 0 || e <= n + h || (0 == a && 0 == h) || (s == t.isDark(o + a, n + h) && i++);
            i > 5 && (r += 3 + i - 5);
          }
        for (o = 0; o < e - 1; o++)
          for (n = 0; n < e - 1; n++) {
...
(QRPolynomial.prototype = {
  ...
  (QRRSBlock.getRSBlocks = function (t, e) {
    ...
    for (var o = r.length / 3, n = [], i = 0; i < o; i++) for (var s = r[3 * i + 0], a = r[3 * i + 1], h = r[3 * i + 2], l = 0; l < s; l++) n.push(new QRRSBlock(a, h));
    return n;
  }),
    ...
    o = (function (t, e) {
      for (
        var r = (function (t) {
          ...
          n = 0,
          i = 0,
          s = QRCodeLimitLength.length;
        i <= s;
        i++
      ) {
        var a = QRCodeLimitLength[i];
        if (!a) throw new Error("Content too long: expected " + n + " but got " + r);
        switch (e) {
          case "L":
            n = a[0];
            break;
...
QRCodeSVG.prototype.svg = function (t) {
  ...
  for (
    var o = void 0 === e.pretty || !!e.pretty,
      ...
      l = s / (h + 2 * e.padding),
      u = a / (h + 2 * e.padding),
      d = void 0 !== e.join && !!e.join,
      g = void 0 !== e.swap && !!e.swap,
      ...
      m = n + '<rect x="0" y="0" width="' + s + '" height="' + a + '" style="fill:' + e.background + ';shape-rendering:crispEdges;"/>' + i,
      p = "",
      v = "",
      Q = 0;
    Q < h;
      ...
      if (r[E][Q]) {
        ...
        if (d) {
          ...
          (M = Number.isInteger(M) ? Number(M) : M.toFixed(2)),
            ...
            (v += "M" + M + "," + w + " V" + (P = Number.isInteger(P) ? Number(P) : P.toFixed(2)) + " H" + B + " V" + w + " H" + M + " Z ");
        } else
          p += c
            ? n + '<use x="' + M.toString() + '" y="' + w.toString() + '" href="#qrmodule" />' + i
            : n + '<rect x="' + M.toString() + '" y="' + w.toString() + '" width="' + l + '" height="' + u + '" style="fill:' + e.color + ';shape-rendering:crispEdges;"/>' + i;
      }
    }
  ...
  switch (t.container) {
    case "svg":
      f && (L += '<?xml version="1.0" standalone="yes"?>' + i),
        (L += '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="' + s + '" height="' + a + '">' + i),
        (L += R + m + p),
        (L += "</svg>");
      break;
    case "svg-viewbox":
      f && (L += '<?xml version="1.0" standalone="yes"?>' + i),
        (L += '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 ' + s + " " + a + '">' + i),
        (L += R + m + p),
        (L += "</svg>");
      break;
    case "g":
      (L += '<g width="' + s + '" height="' + a + '">' + i), (L += R + m + p), (L += "</g>");
      break;
    default:
      L += (R + m + p).replace(/^\s+/, "");
  }
...
const Platform = {
  ...
  isWebWorker: "object" == typeof self && self.constructor && "DedicatedWorkerGlobalScope" === self.constructor.name,
  isJsDom: ("undefined" != typeof window && "nodejs" === window.name) || ("undefined" != typeof navigator && (navigator.userAgent.includes("Node.js") || navigator.userAgent.includes("jsdom"))),
  isDeno: "undefined" != typeof Deno && void 0 !== Deno.core,
};
